...
import type { AlignmentLine, ModelProviderId, RenderLine, Target } from "./types";
...
export const messages = {
  zh: {
    ...
    modelProviderName: (providerId: ModelProviderId) =>
      ({
        deepseek: "DeepSeek",
        openai: "GPT",
        qwen: "Qwen",
    ...
    modelIdLabel: "模型 ID",
    modelLabel: "模型",
    customModelIdLabel: "自定义模型 ID",
    selectModel: "选择模型",
    refreshModelFirst: "填写 Key 后刷新模型",
    ...
    modelsFallback: (count: number) => `未能刷新账号模型，已提供 ${count} 个推荐模型。`,
    enterOrSelectText: "请输入或选中文本。",
    fillServiceUrl: "请先填写 API URL。",
    fillApiKey: "请先填写 API Key。",
    selectModelFirst: "请先选择模型。",
    claudeCompatibilityWarning: "Claude 的 OpenAI 兼容接口适合测试和评估，不建议作为长期生产方案。",
    selectedText: "选中文本",
    grammarError: "存在语法错误",
  ...
  en: {
    ...
    analysisReason: "Explanation",
    analysisUncategorized: "Uncategorized",
    ...
    modelProviderName: (providerId: ModelProviderId) =>
      ({
        ...
        kimi: "Kimi",
        claude: "Claude",
        other: "Other Compatible Service"
      })[providerId],
    apiKeyLabel: "API Key",
    ...
    refreshModelFirst: "Enter an API key and refresh models",
    ...
    modelsFallback: (count: number) => `Could not refresh account models. ${count} recommended models are available.`,
    enterOrSelectText: "Enter or select text first.",
    fillServiceUrl: "Fill the API URL first.",
    fillApiKey: "Fill the API key first.",
    selectModelFirst: "Select a model first.",
    claudeCompatibilityWarning: "Claude's OpenAI compatibility layer is for testing and evaluation, not long-term production use.",
